...
-  We will provide three sets of instructions that students can use to complete this project. One set creates a project that's completely free. The other two sets of instructions require payment in order to create a personalized domain.
...
For this first project, students will combine many of the topics they've learned in the previous units in order to create, deploy, and secure their very own live web application&mdash;an online cyber blog!
...
Introduce the high-level objectives for each day of Project 1 as well as the unit lessons that will be utilized during each day:
...
Remind the class that during the Cloud unit, using Azure, we created several virtual machines.  
...
After students create their web application, they will be able to assign their own unique domain to their website.
  - Point out that Microsoft Azure has an option to choose and assign a domain directly from Azure.
  - Explain that while choosing a domain from Azure provides simplicity and convenience, Azure charges $11.99 per domain.
    - This $11.99 charge cannot be deducted from the $200 free trial credit and will be charged to the student credit card on file.
  
Because of this cost, there are some additional options available to students for lower or no cost. 
...
Review the following three cost options and the advantages and disadvantages of each:
...
- ***Low-Cost Option: GoDaddy 99 Cent Domain*** - Students can elect to choose a domain at low cost, starting at 99 cents.
   - **Advantages**:
   ...
   - **Disadvantages**:
     ...
     - 99 cent domains are usually .info or .website TLDs.
     - Additional steps will be required to point the DNS from GoDaddy over to Azure (these steps will be provided).
  
- ***Higher-Cost Option: Azure's premium domain*** - Students can elect to choose a domain for $11.99.
   - **Advantages**:
      - Students can conveniently and quickly choose a domain right from Azure.
      - Domain choices include .com and .net TLDs.
      - No limitations on any activity this week.
      - No additional setup steps required.
   - **Disadvantages**:
      - Higher cost.

Emphasize that students may choose any of these three options, and they will be provided unique guides dependent on their choice. 
...
Send out the following three student guides:

- [Day 1 Guide Using Free Domain with Azure - No Cost](Activities/azure_free_domain.md) 
- [Day 1 Guide Using Low-Cost Domain with GoDaddy - $0.99](Activities/godaddy_low_price_domain.md) 
- [Day 1 Guide Using Premium Domain with Azure - $11.99](Activities/azure_premium_domain.md) 
