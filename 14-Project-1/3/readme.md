...
Today, students will complete the final tasks for their project. They will be **protect** their web application by utilizing Azure's cloud security features. This day will incorporate topics from the Networking and Web Development units.
...
- Attacks can include:
  ...
  - Attacks against web vulnerabilities, such as Cross Site Scripting and SQL injection (which will be covered in more detail during the web vulnerabilities unit).
