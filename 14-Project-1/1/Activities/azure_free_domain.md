...
4. Next, from the command line, you'll enter a command to configure your container.
   ...
   - After pressing enter, an output similar to the image below should appear:
     ...
     ![A screenshot depicts confirmation that the docker container has successfully uploaded into the application.](../Images/project1_13.png)
...
After you have made your changes, use ctrl + O to save changes. Return to your browser and refresh your webpage.
